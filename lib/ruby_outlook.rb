...
module RubyOutlook
  class Client
    ...
    def initialize
      ...
      @api_host = "https://login.microsoftonline.com"
    ...
    def get_contact_by_id(token, id, fields = nil, user = nil)
      request_url = "/v1.0/" << (user.nil? ? "Me" : ("users/" << user)) << "/Contacts/" << id
      request_params = nil
    ...
    def get_message_by_id(token, id, fields = nil, user = nil)
      request_url = "/v1.0/" << (user.nil? ? "Me" : ("users/" << user)) << "/Messages/" << id
      request_params = nil
    ...
    def send_message(token, payload, save_to_sentitems = true, user = nil)
      request_url = "/v1.0/" << (user.nil? ? "Me" : ("users/" << user)) << "/SendMail"
    ...
    def get_event_by_id(token, id, fields = nil, user = nil)
      request_url = "/v1.0/" << (user.nil? ? "Me" : ("users/" << user)) << "/Events/" << id
      request_params = nil
